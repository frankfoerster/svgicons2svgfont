...
[![License](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/frankfoerster/svgicons2svgfont/blob/main/LICENSE)
[![Tests](https://github.com/frankfoerster/svgicons2svgfont/actions/workflows/test.yml/badge.svg)](https://github.com/frankfoerster/svgicons2svgfont/actions/workflows/test.yml)
[![NPM version](https://img.shields.io/npm/v/@frankfoerster/svgicons2svgfont.svg?style=flat)](https://www.npmjs.com/package/@frankfoerster/svgicons2svgfont)
...
converted to paths. Multiple paths will be merged.

Transform attributes support is currently experimental,
[report issues if any](https://github.com/frankfoerster/svgicons2svgfont/issues/6).
...
```js
import { SVGIcons2SVGFontStream } from '@frankfoerster/svgicons2svgfont';
...
Default value: `require('@frankfoerster/svgicons2svgfont/src/metadata')(options)`

A function that determines the metadata for an icon. It takes a parameter
...
- [Frank Förster](https://github.com/frankfoerster)

# License
[MIT](https://github.com/frankfoerster/svgicons2svgfont/blob/main/LICENSE)
